    ...
    <?php
        ...
        */
        if(isset($_POST['seleccionado'])){
            ...
            */
            $resultado=$inserta_Datos->consultarDatos($campos,'grupo_menu',"","id",$id );
            $resultado=$resultado->fetch_array(MYSQLI_NUM);
            /*
                CREAR EL VECTOR CON LOS ID CORRESPONDIENTES A CADA CAMPO DEL FORMULARIO HTML DE LA PAGINA
            */
            $camposIdForm=array('grupo','observacion');
        }
    ?>
...
<body style="background-color:white">
  <h2>GRUPOS DE MENÚ</h2>
  <!-- DISEÑO DEL FORMULARIO, CAMPOS -->
<form name="grupoMenu" method="POST" onsubmit="return verificar()" style="margin:0px" >
  ...
  <input name="volver" type="button" value="Volver" onclick = "location='grupo_menu_panel.php';"  class="boton-formulario">
</form>
    ...
    if(isset($_POST['grupo'])){
        ...
        */
        if(isset($idForm)&&($idForm!=0)){
            $inserta_Datos->modificarDato('grupo_menu',$campos,$valores,'id',$idForm);
        }else{
            $inserta_Datos->insertarDato('grupo_menu',$campos,$valores);
        }
    }
}
?>
