    ...
    <?php
        ...
        */
        if(isset($_POST['seleccionado'])){
            ...
            */
            $resultado=$inserta_Datos->consultarDatos($campos,'adjuntos_categoria',"","id",$id );
    ...
    if(isset($_POST['dsc_categoria'])){
        ...
        */
        if(isset($idForm)&&($idForm!=0)){
            $inserta_Datos->modificarDato('adjuntos_categoria',$campos,$valores,'id',$idForm);
        }else{
            $inserta_Datos->insertarDato('adjuntos_categoria',$campos,$valores);
        }
    }
}
?>
