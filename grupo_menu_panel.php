...
// DATOS
$cabecera=['Grupo','Observación'];
$campos=['descripcion','obs'];
...
<!--============================================================================= -->
        ...
        <div class="menu-panel" >
            ...
            <input type="button" class="boton_panel" name="Editar" value="Editar" onclick="editar('grupo_menu_form.php')">
            <input type="button" class="boton_panel" name="Eliminar" value="Eliminar"
            id="eliminarTest" onclick="popupC('Advertencia','Esta seguro de que desea eliminar? los cambios son irreversibles',function (){eliminar('grupo_menu')},'grupo_menu')">
            <!--<input type="button" class="boton_panel" name="Eliminar" value="Eliminar" onclick="eliminar('categoria')">-->
        </div>

        <div class="mostrar-tabla">
            <?php
             $consultas->crearTabla($cabecera,$campos,'grupo_menu');
