...
// ========================================================================
$cabecera = ['ID', 'Nombre/s', 'Apellido/s', 'Correo Electrónico', 'Teléfono', 'C.I / R.U.C', 'Fecha Creación'];
$campos = ['id', 'dsc_cliente', 'apellido', 'mail', 'telefono1', 'ci_ruc', 'fecreacion'];
?>
<!DOCTYPE html>
...
<head>
    ...
    <script type="text/javascript">
        ...
        var campos = ['id', 'dsc_cliente', 'apellido', 'mail', 'telefono1', 'ci_ruc', 'fecreacion'];
    </script>
    <style media="screen">
        .menu-panel {
            width: 100%
...
<script>
    function buscar() {
        ...
        where += " dsc_cliente LIKE '%" + dsc_cliente.value + "%' OR ci_ruc LIKE '%" +
            dsc_cliente.value + "%' " + " OR apellido LIKE '%" + dsc_cliente.value + "%'";
        c++;
        }
        //}
