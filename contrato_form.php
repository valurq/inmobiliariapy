    ...
    <?php
        ...
        */
        if(isset($_POST['seleccionado'])){
            ...
            */
            $camposIdForm=array('moneda', 'vigencia_hasta', 'fee_adm', 'fee_operaciones', 'fee_marketing', 'fee_afiliacion', 'obs', 'estado');
        }
    ?>
  ...
  <table class="tabla-fomulario">
    <tbody>
      ...
      <tr>
          ...
          <td><input type="number" name="fee_adm" id="fee_adm" class="campos-ingreso"></td>
      </tr>
      <tr>
          <td><label for="">Porcentaje a pagar sobre operaciones</label></td>
          <td><input type="number" name="fee_operaciones" id="fee_operaciones" class="campos-ingreso"></td>
      </tr>
      <tr>
          <td><label for="">Pago mensual marketing</label></td>
          <td><input type="number" name="fee_marketing" id="fee_marketing" class="campos-ingreso"></td>
      </tr>
      <tr>
          <td><label for="">Pago afiliación</label></td>
          <td><input type="number" name="fee_afiliacion" id="fee_afiliacion" class="campos-ingreso"></td>
      </tr>
      <tr>
